...
$sql_media = "SELECT file_path, media_type FROM post_group_media WHERE post_id = ?";
...
$sql_comments = "SELECT c.id, c.content, c.created_at, u.username as comment_author, u.is_verified
                 FROM group_comments c JOIN users u ON c.user_id = u.id
...
<div class="container mt-4">
    <a href="community_management.php?type=group" class="btn btn-secondary mb-3">&laquo; Quay lại danh sách</a>
        ...
        <ul class="list-group">
            ...
            ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <a href="delete_group_comment.php?comment_id=<?= $comment['id'] ?>&post_id=<?= $post_id ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn chắc chắn muốn xóa bình luận này?');">Xóa</a>
                </li>
            <?php
                }
            } else {
